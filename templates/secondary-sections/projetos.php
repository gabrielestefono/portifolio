<section class="adminprojects">
    ...
    <table class="adminprojects__table">
        ...
        <tr class="adminprojects__table--row">
            ...
            <td class="adminprojects__table--row_see adminprojects__table--row_item"><a href="admin.php?pag=rprojetos.php&see=<?=$valor['id']?>&type=2" class="adminprojects__table--row_item-link"><i class="fa-regular fa-eye"></i></a></td>
            <td class="adminprojects__table--row_edit adminprojects__table--row_item"><a href="admin.php?pag=uprojetos.php&see=<?=$valor['id']?>&type=2" class="adminprojects__table--row_item-link"><i class="fa-regular fa-pen-to-square"></i></a></td>
            <td class="adminprojects__table--row_delete adminprojects__table--row_item"><a href="admin.php?pag=dprojetos.php&see=<?=$valor['id']?>&type=2" class="adminprojects__table--row_item-link"><i class="fa-regular fa-trash-can"></i></a></td>
        </tr>
        <?php endforeach; ?>
    </table>
