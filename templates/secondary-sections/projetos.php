<section class="adminprojects">
    ...
    <table class="adminprojects__table">
        ...
        <tr class="adminprojects__table--row">
            ...
            <td class="adminprojects__table--row_delete adminprojects__table--row_item"><a href="admin.php?pag=crud/dprojetos.php&see=<?=$valor['id']?>" class="adminprojects__table--row_item-link"><i class="fa-regular fa-trash-can"></i></a></td>
        </tr>
        <?php endforeach; ?>
    </table>
